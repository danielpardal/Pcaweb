...
<html>
    ...
    <body>
        ...
        <div id="show-veterinario" class="content scaffold-show" role="main">
            ...
            <f:display bean="veterinario" />
            <g:form resource="${this.veterinario}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.veterinario}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-exame" class="content scaffold-show" role="main">
            ...
            <f:display bean="exame" />
            <g:form resource="${this.exame}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.exame}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
